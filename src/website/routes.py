...
def home():
    return render_template(
        "pages/home.html", page={"title": None, "permalink": "/"}, active_page="home"
    )
...
def aboutwebsite():
    description = "About anuroopsriram.com — built with Flask and Frozen-Flask, deployed on GitHub Pages."
    return render_template(
        "pages/aboutwebsite.html",
        page={
